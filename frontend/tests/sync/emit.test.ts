...
import type { RegistryItem, TagDict } from '../../scripts/sync-from-skill/types';
...
const sample = (id: string): RegistryItem => ({
  ...
  tags: { aesthetic: ['minimal'], mood: ['calm'], theme: ['light'], stack: ['html-tailwind'] },
  uses: [],
  usedBy: [],
