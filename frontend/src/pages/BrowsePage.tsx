  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="bg-[#fafafa]">
        <div className="mx-auto max-w-[1600px] px-8 pt-12">
          <h1 className="font-display text-[40px] font-semibold leading-[1.08] tracking-[-0.02em] text-slate-900 md:text-[52px]">
