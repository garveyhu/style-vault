  ...
  return (
    <PreviewFrame bg="rgb(249,249,249)" padded={false}>
      <div style={{ position: 'relative', height: 600, fontFamily: 'Inter, sans-serif' }}>
        {/* 模拟 chat 背景 */}
        <div style={{ position: 'absolute', inset: 0, background: 'rgb(249,249,249)', padding: 24, color: '#94a3b8', fontSize: 12 }}>
          ...
          <p style={{ color: '#64748b', fontSize: 13 }}>rounded-3xl · 红圆 AlertTriangle · slate-900/10 极淡蒙层</p>
