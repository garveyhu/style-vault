...
- `CORS_ORIGINS`（默认 `http://localhost:5173` / `5174`）
...
默认允许 `http://localhost:5173` 和 `http://localhost:5174`，`credentials=True`。
...
- [ ] **Google Cloud Console 配置**（需用户手动做）：
    ...
    - 创建 / 编辑 Web OAuth 2.0 Client ID `160104575584-magsnq73oenb32fs90r65avlce16ec5p.apps.googleusercontent.com`
